...
/**
 * A data dumper that reverse-maps sanitized column names back to their original names.
 *
 * The connector sanitizes column names (alphanumeric + underscore only), but the test framework
 * expects the original field names from the source schema. This dumper:
