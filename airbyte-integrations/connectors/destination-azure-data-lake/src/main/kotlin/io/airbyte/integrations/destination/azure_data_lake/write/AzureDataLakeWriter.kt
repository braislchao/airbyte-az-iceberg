...
import io.airbyte.integrations.destination.azure_data_lake.spec.DEFAULT_STAGING_BRANCH
import javax.inject.Singleton
import org.apache.iceberg.catalog.TableIdentifier

@Singleton
class AzureDataLakeWriter(
    ...
    override fun createStreamLoader(stream: DestinationStream): StreamLoader {
        return AzureDataLakeStreamLoader(
            icebergConfiguration,
            stream,
            icebergTableSynchronizer,
            azureDataLakeCatalogUtil,
            icebergUtil,
            stagingBranchName = DEFAULT_STAGING_BRANCH,
            mainBranchName = icebergConfiguration.azureCatalogConfiguration.mainBranchName,
